 ...
 * @brief Contiene il parser del file di configurazione
 */
...
/**
 * @brief Decodifica la chiave passata come argomento e restituisce il numero di campo
 *
 * @param key -- chiave da decodificare
 *
 * @return numero di campo riconosciuto,
 *         -1 in caso di errore
 */
...
/**
 * @brief Legge il valore passato come argomento, lo controlla e setta
 *        l'opzione corrispondente
 *
 * @param value -- valore del campo
 * @param index -- numero del campo
 *
...
/**
 * @brief Apre il file di configurazione e lo decodifica carattere per carattere
 *
 * La funzione e' essenzialmente un automa a stati finiti
 * @param
