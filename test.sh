...
for((i=0;i<1000;++i)); do
    ./client -l $1 -k pippo -L &
done
# ./client -l $1 -c utente1 &
# ./client -l $1 -c utente2 &
# ./client -l $1 -c utente3 &
# ./client -l $1 -c utente4 &
# ./client -l $1 -c utente5 &
# ./client -l $1 -c utente6 &
# ./client -l $1 -c utente7 &
# ./client -l $1 -c utente8 &
# ./client -l $1 -c utente9 &
# ./client -l $1 -c utente10 &
